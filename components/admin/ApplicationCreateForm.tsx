...
export function ApplicationCreateForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setSaved(true);
      setName(""); setVendor(""); setDescription("");
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="app-name" value={name} onChange={(e) => setName(e.target.value)} placeholder="ex : Salesforce CRM" required minLength={2} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="app-vendor">Éditeur (optionnel)</Label>
            <Input id="app-vendor" value={vendor} onChange={(e) => setVendor(e.target.value)} placeholder="ex : Salesforce, SAP, Microsoft" />
          </div>
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={2}
              placeholder="Rôle de l'application dans l'organisation..."
