...
export function DomainEditForm({ domainId, initialName, initialDescription }: DomainEditFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg space-y-4 rounded-2xl border border-[--border] bg-[--bg-card] p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <p className="text-sm font-semibold text-[--text-primary]">Modifier le domaine</p>
